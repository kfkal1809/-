...
export const DATE_FORTUNE_REWARD_MIN = 2;
export const DATE_FORTUNE_REWARD_MAX = 4;

// 데이트 콘텐츠 6 — 오늘의 운세. 대화 주제 카드와 동일한 구조(household 하루 1회, 정적
// 문구 목록에서 랜덤 뽑기 + 소액 보상)로, 오늘 하루 커플에게 어떤 일이 생길지 재미로
// 점쳐보는 콘텐츠다.
export const DATE_FORTUNE_MESSAGES = [
  "오늘은 사소한 말 한마디가 큰 감동을 줄 거예요.",
  "함께 먹는 음식이 유난히 맛있게 느껴지는 하루예요.",
  "오늘 나눈 대화가 오래도록 기억에 남을 거예요.",
  "작은 다툼이 있어도 금방 풀리는 화목한 하루예요.",
  "예상치 못한 곳에서 서로의 닮은 점을 발견해요.",
  "오늘은 평소보다 스킨십에 진심이면 좋은 하루예요.",
  "함께 웃을 일이 유독 많이 생기는 하루예요.",
  "서로에게 좋은 소식을 전하게 될 운이에요.",
  "오늘의 작은 배려가 두 사람 사이를 더 단단하게 해줘요.",
  "함께 있는 것만으로도 마음이 든든해지는 하루예요.",
  "오늘 꺼낸 이야기가 다음 데이트 계획으로 이어질 거예요.",
  "서로의 취향을 하나 더 알게 되는 좋은 기회가 생겨요.",
  "오늘은 평소보다 애정 표현에 솔직해져도 좋은 날이에요.",
  "작은 선물 하나가 큰 행복으로 돌아오는 하루예요.",
  "둘이 함께라면 오늘 하루도 문제없이 잘 풀려요.",
];
