...
export const ITEM_APPEARANCE_PATCH: Record<string, Partial<CharacterAppearance>> = {
  // 해녀 옷
  // 플레이어 캐릭터(kind 있음)는 outfitAssetKey 하나로만 렌더링한다(MASTER 기본 체형 →
  // outfitAssetKey 전신 스프라이트를 목선 앵커에 맞춰 얹는 방식). 예전엔 완성 전신 PNG를
  // 통째로 그리는 fullPortraitKey 경로가 따로 있었는데, 두 경로가 서로 다른 스케일 공식을
  // 써서 같은 캐릭터인데 의상마다 머리 크기·키·다리 길이가 달라지는 버그가 있었다 — 모든
  // dress_full 자산을 outfitAssetKey 규격으로 재변환해(scripts/asset-tools/
  // convert_dress_full_to_outfit.py) 경로 자체를 없앴다(CharacterSprite.tsx 참고).
  ...
  // 이미 하나로 합쳐진 전신 스프라이트라 outfitAssetKey 하나만 연결하면 끝난다.
  haenyeo_outfit_sailor: { outfitAssetKey: "haenyeo_outfit_01" },
  haenyeo_outfit_floral: { outfitAssetKey: "haenyeo_outfit_03" },
  haenyeo_outfit_mint_cardigan: { outfitAssetKey: "haenyeo_outfit_04" },
  haenyeo_outfit_navy_skirt: { outfitAssetKey: "haenyeo_outfit_05" },
  haenyeo_outfit_flower_skirt: { outfitAssetKey: "haenyeo_outfit_07" },
  haenyeo_outfit_duck_raincoat: { outfitAssetKey: "haenyeo_outfit_08" },
  haenyeo_outfit_pink_bear: { outfitAssetKey: "haenyeo_outfit_09" },
  haenyeo_outfit_autumn_coat: { outfitAssetKey: "haenyeo_outfit_10" },
  haenyeo_outfit_navy_crossbag: { outfitAssetKey: "haenyeo_outfit_11" },
  haenyeo_outfit_scuba: { outfitAssetKey: "haenyeo_outfit_12" },
  haenyeo_outfit_bear_check: { outfitAssetKey: "haenyeo_outfit_13" },
  haenyeo_outfit_resort_bikini: { outfitAssetKey: "haenyeo_outfit_14" },
  haenyeo_outfit_pink_bear_dress: { outfitAssetKey: "haenyeo_outfit_15" },
  ...
  haenyeo_dress_sailor_mini: { outfit: "dress", outfitColor: "#f2b8c6", outfitAssetKey: "haenyeo_dress_01" },
  haenyeo_dress_coral_cardigan: { outfit: "dress", outfitColor: "#f2b8c6", outfitAssetKey: "haenyeo_dress_03" },
  haenyeo_dress_lavender_shirt: { outfit: "dress", outfitColor: "#f2b8c6", outfitAssetKey: "haenyeo_dress_04" },
  haenyeo_dress_coral_slip: { outfit: "dress", outfitColor: "#f2b8c6", outfitAssetKey: "haenyeo_dress_05" },
  haenyeo_dress_yellow_check: { outfit: "dress", outfitColor: "#f2b8c6", outfitAssetKey: "haenyeo_dress_06" },
  haenyeo_dress_white_lace: { outfit: "dress", outfitColor: "#f2b8c6", outfitAssetKey: "haenyeo_dress_07" },
  haenyeo_dress_beige_dot: { outfit: "dress", outfitColor: "#f2b8c6", outfitAssetKey: "haenyeo_dress_08" },
  haenyeo_dress_coral_shirt: { outfit: "dress", outfitColor: "#f2b8c6", outfitAssetKey: "haenyeo_dress_09" },
  haenam_deck_outfit_shirt_white: { outfitAssetKey: "haenam_deck_outfit_01" },
  haenam_deck_outfit_knit_sweater: { outfitAssetKey: "haenam_deck_outfit_03" },
  haenam_deck_outfit_denim_jacket: { outfitAssetKey: "haenam_deck_outfit_05" },
  haenam_deck_outfit_tee_shorts: { outfitAssetKey: "haenam_deck_outfit_06" },
  haenam_deck_outfit_hoodie_jogger: { outfitAssetKey: "haenam_deck_outfit_07" },
  haenam_deck_outfit_overfit_shirt: { outfitAssetKey: "haenam_deck_outfit_09" },
  haenam_deck_outfit_homewear: { outfitAssetKey: "haenam_deck_outfit_10" },
  haenam_deck_outfit_captain: { outfitAssetKey: "haenam_deck_outfit_11" },
  haenam_deck_outfit_uniform_map: { outfitAssetKey: "haenam_deck_outfit_12" },
  haenam_deck_outfit_sweater_camera: { outfitAssetKey: "haenam_deck_outfit_13" },
  haenam_deck_outfit_sunglasses_casual: { outfitAssetKey: "haenam_deck_outfit_14" },
  haenam_deck_outfit_yellow_raincoat: { outfitAssetKey: "haenam_deck_outfit_15" },
  haenam_deck_outfit_red_safety_vest: { outfitAssetKey: "haenam_deck_outfit_16" },
  haenam_deck_outfit_ocean_hoodie: { outfitAssetKey: "haenam_deck_outfit_17" },
  haenam_deck_outfit_hoodie_crossbag: { outfitAssetKey: "haenam_deck_outfit_18" },
  haenam_deck_outfit_trench_coffee: { outfitAssetKey: "haenam_deck_outfit_19" },
  haenam_deck_outfit_hawaiian_shirt: { outfitAssetKey: "haenam_deck_outfit_20" },
  haenam_deck_outfit_dolphin_pajama: { outfitAssetKey: "haenam_deck_outfit_21" },
  haenam_deck_outfit_scarf_coat: { outfitAssetKey: "haenam_deck_outfit_22" },
  haenam_engine_outfit_tee_navy: { outfitAssetKey: "haenam_engine_outfit_02" },
  haenam_engine_outfit_tee_workpants: { outfitAssetKey: "haenam_engine_outfit_04" },
  haenam_engine_outfit_hoodie_casual: { outfitAssetKey: "haenam_engine_outfit_05" },
  haenam_engine_outfit_overalls_denim: { outfitAssetKey: "haenam_engine_outfit_06" },
  haenam_engine_outfit_sweatshirt: { outfitAssetKey: "haenam_engine_outfit_07" },
  haenam_engine_outfit_sport: { outfitAssetKey: "haenam_engine_outfit_08" },
  haenam_engine_outfit_pajama_check: { outfitAssetKey: "haenam_engine_outfit_09" },
  haenam_engine_outfit_winter_padding: { outfitAssetKey: "haenam_engine_outfit_10" },
  haenam_engine_outfit_safety_orange: { outfitAssetKey: "haenam_engine_outfit_11" },
  haenam_engine_outfit_toolbelt: { outfitAssetKey: "haenam_engine_outfit_12" },
  haenam_engine_outfit_towel_gloves: { outfitAssetKey: "haenam_engine_outfit_13" },
  haenam_engine_outfit_mug_casual: { outfitAssetKey: "haenam_engine_outfit_14" },
  haenam_engine_outfit_headphones_hoodie: { outfitAssetKey: "haenam_engine_outfit_15" },
  haenam_engine_outfit_engineroom_hoodie: { outfitAssetKey: "haenam_engine_outfit_16" },
  haenam_engine_outfit_tank_wrench: { outfitAssetKey: "haenam_engine_outfit_17" },
  haenam_engine_outfit_tablet_shirt: { outfitAssetKey: "haenam_engine_outfit_18" },
  haenam_engine_outfit_snorkel_tank: { outfitAssetKey: "haenam_engine_outfit_19" },
  haenam_engine_outfit_long_padding: { outfitAssetKey: "haenam_engine_outfit_20" },
  haenam_engine_outfit_cloud_pajama: { outfitAssetKey: "haenam_engine_outfit_21" },
  haenam_engine_outfit_overalls_skewer: { outfitAssetKey: "haenam_engine_outfit_22" },
  ...
  child_outfit_cream_romper: { outfitAssetKey: "child_outfit_01" },
  child_outfit_blue_shirt_bag: { outfitAssetKey: "child_outfit_03" },
  child_outfit_white_green_set: { outfitAssetKey: "child_outfit_06" },
  child_outfit_stripe_set: { outfitAssetKey: "child_outfit_07" },
  child_outfit_yellow_raincoat: { outfitAssetKey: "child_outfit_08" },
  child_outfit_blue_pajama: { outfitAssetKey: "child_outfit_09" },
  child_outfit_winter_coat_scarf: { outfitAssetKey: "child_outfit_10" },
};
