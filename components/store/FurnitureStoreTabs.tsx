import { STORE_TABS, type StoreTabKey } from "@/lib/domain/furnitureStoreCategories";

export function FurnitureStoreTabs({ active, onChange }: { active: StoreTabKey; onChange: (tab: StoreTabKey) => void }) {
  return (
